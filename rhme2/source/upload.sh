...
#avrdude -p m328p -c avrispmkII -e -u -U flash:w:main/ctf.hex -P /dev/ttyUSB0
#avrdude -p m328p -c avrispmkII -u -U lock:w:0x3c:m -P /dev/ttyUSB0

# upload via bootloader
avrdude -p m328p -c arduino -P /dev/ttyUSB0 -b 115200 -e -V -u -U flash:w:main/ctf.hex
